...
function find_category(element) {
    ...
    let category_exists_check = get_submission_list("category").find(
...
function activity_in_category(element, tag_element) {
...
document.addEventListener("DOMContentLoaded", () => {   
    ...
    // find_category(element) function
    window.find_category = find_category;

    // format_category_name(category_name) function
    window.find_activity = find_activity;

    // activity_in_category(element, tag_element) function
